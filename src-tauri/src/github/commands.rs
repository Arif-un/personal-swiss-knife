...
#[tauri::command]
pub fn readd_ci_label(repo: String, number: u64) -> Result<Vec<String>, String> {
...
#[tauri::command]
pub fn fetch_unresolved_comment_counts(
    repo: String,
    numbers: Vec<u64>,
) -> Result<HashMap<u64, u64>, String> {
...
#[tauri::command]
pub fn fetch_merge_queue_status(
    repo: String,
    numbers: Vec<u64>,
...
#[tauri::command]
pub fn fetch_pr_checks(repo: String, number: u64) -> Result<Vec<PrCheck>, String> {
